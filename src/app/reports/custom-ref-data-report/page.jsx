...
const CustomRefDataReportPage = () => {
  ...
  const fetchReportAttributes = (source) => {
    const fetchSettings = `/custom-ref-data/get/attributes/${source.label}`;
  ...
  const fetchReportSources = () => {
    const fetchReportSources = `/custom-ref-data/get/table-names`;
  ...
  const executeReport = () => {
    ...
    const executeReportAPI = `/custom-ref-data/execute/${reportSource.value}`;
  ...
  const downloadReport = () => {
    ...
    reportingApi.post(`/custom-ref-data/download/${reportSource.value}`, filteredCriteriaList, {
      ...
      .then(response => {
        ...
        let fileName = 'ref-data-report.xlsx';
