...
const fetchReportAttributes = (source) => {
  const fetchSettings = `${process.env.NEXT_PUBLIC_REPORTING_SERVICE_URI}/custom-ref-data/get/attributes/${source.label}`;
...
const fetchReportSources = () => {
  const fetchReportSources = `${process.env.NEXT_PUBLIC_REPORTING_SERVICE_URI}/custom-ref-data/get/table-names`;
  ...
  const executeReport = () => {
    ...
    const executeReportAPI = `${process.env.NEXT_PUBLIC_REPORTING_SERVICE_URI}/custom-ref-data/execute/${reportSource.value}`;
...
export default CustomRefDataReportPage;